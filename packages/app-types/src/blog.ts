...
export const BlogPostContentSchema = z.array(
	z.union([BlogPostParagraphContentSchema, BlogPostTitleContentSchema])
);
...
export const BlogPostBaseSchema = z.object({
	...
	uri: z
		.string()
		.regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, 'URI must be URL-friendly'),
